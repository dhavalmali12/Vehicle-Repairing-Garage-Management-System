...
def About (request):
    ...
    msg='''  <!-- ✅ Scrolling Service Section -->
         <section class="slider-container">
        <div class="slider">
            <div class="slide">
                <img src="/Static/Img/Range Rover.jpg" alt="Car Wash"></div>
                <div class="slide">
                    <img src="/Static/Img/MUSTANG.jpg" alt="Engine Repair"></div>
                    <div class="slide">
                        <img src="/Static/Img/BMW M5.jpg" alt="Oil Change"></div>
                    </div>
                </section>
                '''
    to='dkgelot13@gmail.com'         
    ms=EmailMultiAlternatives(subject,msg)
